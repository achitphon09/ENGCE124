...
public class Booking {
    ...
    static void add() {
        ...
        for (int i = 0; i < count - 1; i++) {
            ...
            if (r == null) continue;
            if (r.sameCustomer(newRes)) dup = true;
            else if (r.sameSlot(newRes)) dbl = true;
        }

        if (dup) System.out.println("Duplicate booking");
        else if (dbl) System.out.println("Double booking");
    }
